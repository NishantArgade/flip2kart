  ...
  return (
    <>
      <div className="container mx-auto bg-red-20 w-full  grid grid-cols-12 object-center gap-x-2 m-2 ">
        <div className="col-span-4 bg-white h-[35rem] sticky top-[4.6rem] left-0 shadow-md">
          <ProductIMGCarousel />
          <div className="flex justify-end items-center gap-x-2 mt-3 mr-2">
        ...
        <div className="col-span-8 bg-white shadow-md p-2 flex flex-col justify-start items-start gap-y-4 ">
          {/* Basic Info */}
          <div className="flex flex-col justify-start items-start gap-y-2 relative">
            <p className="text-md">
            ...
            <div className="absolute top-0 right-0 flex justify-center items-center border-2 px-[0.1rem] rounded-md text-gray-300 cursor-pointer">
              <IoMdHeart size={29} />
            </div>
          </div>
