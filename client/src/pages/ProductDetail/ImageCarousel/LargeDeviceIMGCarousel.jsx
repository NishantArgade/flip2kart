...
export default function ProductIMGCarousel() {
  ...
  return (
    <div className="hidden md:flex flex-col-reverse md:flex-row justify-start items-start ">
      <div className="md:h-[16.5rem] lg:h-[27rem] overflow-y-auto thin-scrollbar">
        <Dots
